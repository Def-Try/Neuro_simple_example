    ...
    def train(self, data, all_y_trues):
        ...
        for epoch in range(epochs):
            for x, y_true in zip(data, all_y_trues):
                ...
                o1 = sigmoid(sum_o1)
                y_pred = o1 # текущее предсказание
                ...
                # Нейрон o1
                d_ypred_d_w5 = h1 * deriv_sigmoid(sum_o1) # изменение для веса 1
                d_ypred_d_w6 = h2 * deriv_sigmoid(sum_o1) # изменение для веса 2
                d_ypred_d_b3 = deriv_sigmoid(sum_o1)      # изменение для веса 1
